...
@Component({
  selector: 'app-prestataire-processe-component',
  imports: [CommonModule ,FormsModule],
  standalone: true,
  templateUrl: './prestataire-processe-component.html',
  styleUrls: ['./prestataire-processe-component.css']
})
export class PrestataireProcesseComponent {
  ...
  recapItem = {
    ...
    budget: 234,
    image: 'https://avatars.mds.yandex.net/i?id=aa1cccec7df022a5391135ec0276d244cffffab0-2769679-images-thumbs&n=13'
  };
